...
namespace Dhl\LabelStatus\Model;

use Dhl\LabelStatus\Api\Data\LabelStatusSearchResultsInterface;
use Dhl\LabelStatus\Api\Data\LabelStatusSearchResultsInterfaceFactory;
use Dhl\LabelStatus\Api\LabelStatusRepositoryInterface;
use Dhl\LabelStatus\Api\Data\LabelStatusInterface;
use Dhl\LabelStatus\Api\Data\LabelStatusInterfaceFactory;
use Dhl\LabelStatus\Model\ResourceModel\Label\LabelStatus as LabelStatusResourceModel;
use Dhl\LabelStatus\Model\ResourceModel\Label\LabelStatus;
use Dhl\LabelStatus\Model\ResourceModel\Label\Status\Collection;
use Dhl\LabelStatus\Model\ResourceModel\Label\Status\CollectionFactory;
...
class LabelStatusRepository implements LabelStatusRepositoryInterface
{
    ...
    {
        /** @var \Dhl\LabelStatus\Model\Label\LabelStatus $labelStatus */
        $labelStatus = $this->labelStatusFactory->create();
